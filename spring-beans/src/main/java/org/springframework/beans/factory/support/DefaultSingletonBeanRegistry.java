...
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
	...
	/**
	 * wh:this.singletonsCurrentlyInCreation.add(beanName),保存正在创建中的bean,
	 * 	bean循环依赖时，可以根据singletonsCurrentlyInCreation来判断相互依赖的bean是否在创建中
	 *
	 * -----------------------------------
	...
	protected void afterSingletonCreation(String beanName) {
		//fixme wh:singletonsCurrentlyInCreation.remove(beanName)手动回收资源，GC无法回收
